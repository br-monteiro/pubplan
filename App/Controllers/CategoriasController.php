...
class CategoriasController extends Controller implements ControllerInterface
{
    ...
    public function __construct()
    {
        ...
        $this->view['controller'] = APPDIR . 'categorias/';

        $this->modelDefault = CategoriasModel::class;
    ...
    public function novoAction()
    {
        ...
        $this->render('categorias.form_novo');
    }
    ...
    public function editarAction()
    {
        ...
        $this->render('categorias.form_editar');
    }
