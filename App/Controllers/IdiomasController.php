...
class IdiomasController extends Controller implements ControllerInterface
{
    ...
    public function __construct()
    {
        ...
        $this->view['controller'] = APPDIR . 'idiomas/';

        $this->modelDefault = IdiomasModel::class;
    ...
    public function editarAction()
    {
        ...
        $this->render('idiomas.form_editar');
    }
