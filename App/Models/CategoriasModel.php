...
class CategoriasModel extends ModelCRUD
{
    use \App\Validators\CategoriasValidatorTrait;

    /**
     * Entidade padrão do Model
     */
    protected $entidade = 'categorias';
    protected $id;
    protected $nome;
    ...
    {
        if ($this->delete($id)) {
            header('Location: ' . APPDIR . 'categorias/visualizar/');
        }
    }
